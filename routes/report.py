...
def list_relatorio():
    ...
    itemList = []
    for item in report:
        itemList = [item.id, item.report_data, item.recipe, item.sequencia, item.product1, item.weight1, item.allotment1, item.product2, item.weight2, item.allotment2, item.product3, item.weight3, item.allotment3, item.product4, item.weight4, item.allotment4, item.product5, item.weight5, item.allotment5, item.product6, item.weight6, item.allotment6, item.product7,
